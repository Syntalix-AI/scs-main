        ...
        <div className="flex items-center justify-between mx-auto w-full px-4 md:px-12">
          ...
          <div className="flex items-center gap-4 pointer-events-auto">
            ...
            <button
              ...
              className="hidden md:block px-6 py-2.5 rounded-full bg-gradient-to-r from-primary to-secondary text-white text-sm font-bold shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:scale-105 transition-all duration-300"
            >
              Contact Us
            </button>
          </div>
